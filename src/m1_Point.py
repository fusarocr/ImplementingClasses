...
class Point(object):
    ...
    def move_to(self, x, y):
        self. travel_distance = self.travel_distance + \
                                self.get_distance_from(Point(x, y))
        self.x = x
        self.y = y
    ...
    def move_by(self, dx, dy):
        ...
        self.y = self.y + dy
        self.moves = self.moves + 1
        self.travel_distance = self.travel_distance + math.sqrt(dx**2 + dy**2)
    ...
    def closer_to(self, point1, point2):
        d1 = self.get_distance_from(point1)
        d2 = self.get_distance_from(point2)
